...
export const minioClient = new Minio.Client({
    ...
    port: parseInt(process.env.PRIVATE_MINIO_PORT),
    useSSL: false,
    accessKey: process.env.PRIVATE_BUCKET_ACCESS_KEY,
    secretKey: process.env.PRIVATE_BUCKET_SECRET_KEY,
    region: "us-east-1",
    pathStyle: true
});
 ...
 */
export const bucketName = process.env.PUBLIC_BUCKET_NAME;
